  ...
  <div class="user">
    <div class="userContainer">
      ...
      <div class="userShow">
        ...
        <p><a href="javascript:login()" class="user_login">登录</a>&nbsp;|&nbsp;<a href="javascript:regist()" class="user_reg">注册</a></p>
      </div>
    </div>
    <div class="user_profit">
      <a class="user_profit_lk" href="//xinren.jd.com/?channel=99" target="_blank" >新人福利</a>
      <a class="user_profit_lk user_profit_lk_plus" href="//plus.jd.com/index?flow_system=appicon&amp;flow_entrance=appicon3&amp;flow_channel=pc" target="_blank" >PLUS会员</a>
    </div>
  </div>
</template>
